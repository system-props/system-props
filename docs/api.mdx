...
```js
import { space } from 'system-props';
```
...
```js
import { background } from 'system-props';
```
...
```js
import { border } from 'system-props';
```
...
```js
import { position } from 'system-props';
```
...
```js
import { shadow } from 'system-props';
```
...
import { compose, typography, space, color } from 'system-props';
...
```js
import styled from 'styled-components'
import { themeGet } from '@system-props/theme-get'
...
```jsx
import styled from 'styled-components'
import { width } from 'system-props'
