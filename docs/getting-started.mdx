...
```js
import { createSystem, space, color, typography } from 'system-props';

const system = createSystem();

const Box = styled.div({ ...space, ...color, ...typography });
```

<Playground>
  <Box as="h3" textAlign="center" fontSize="lg" bg="primary" color="white" py={2}>Welcome to System Props!</Box>
</Playground>
